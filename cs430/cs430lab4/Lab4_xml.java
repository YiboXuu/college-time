...
//library
                    ...
                    Element liElmnt = (Element) libraryElementList.item(0);
                    NodeList li = liElmnt.getChildNodes();
                    //System.out.println("Library : "  + ((Node) li.item(0)).getNodeValue().trim());
                    library = ((Node) li.item(0)).getNodeValue().trim();
                    ...
                    if (!isbn.isEmpty() && member_id > -1 && !checkout_date.isEmpty() && !checkin_date.isEmpty()) {
                        BorrowedBy borrowedBy = new BorrowedBy(isbn, member_id, library ,checkout_date, checkin_date);
